...
<ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
  ...
  <li class="nav-title">Modüller</li>
    ...
    <li class="nav-group <?= ($active ?? '') === 'products' ? 'show' : '' ?>">
      <a class="nav-link nav-group-toggle" href="#">
        <i class="nav-icon cil-storage"></i> Ürün Yönetimi
      </a>
      <ul class="nav-group-items">
        <li class="nav-item">
          <a class="nav-link<?= ($sub??'')==='all' ? ' active' : '' ?>" href="/products">
            <i class="nav-icon cil-list"></i> Tüm Ürünler
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link<?= ($sub??'')==='incoming' ? ' active' : '' ?>" href="/products/incoming">
            <i class="nav-icon cil-calendar"></i> Gelecek Ürünler
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link<?= ($sub??'')==='deleted' ? ' active' : '' ?>" href="/products/deleted">
            <i class="nav-icon cil-trash"></i> Silinen Ürünler
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link<?= ($sub??'')==='rentals' ? ' active' : '' ?>" href="/products/rentals">
            <i class="nav-icon cil-layers"></i> Kiradaki Ürünler
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link<?= ($sub??'')==='tailor' ? ' active' : '' ?>" href="/products/tailor">
            <i class="nav-icon cil-cut"></i> Terzideki Ürünler
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link<?= ($sub??'')==='dry' ? ' active' : '' ?>" href="/products/dry-clean">
